...
## Rendere la casella dei nomi disponibile per lo styling attraverso l'oggetto
## Character.
init python:
...
screen navigation():
    ...
    vbox:
        ...
        if renpy.variant("pc"):
            ...
            ## Il pulsante di abbandono è vietato su iOS e non è necessario su
            ## Android e sul Web.
            ...
            vbox:
                ...
                if config.has_sync:
                    if CurrentScreenName() == "save":
                        textbutton _("Sincronizzazione del caricamento"):
                            action UploadSync()
                            xalign 0.5
                    else:
                        textbutton _("Scarica Sync"):
                            action DownloadSync()
                            xalign 0.5
...
## Determina quali tag possono essere visualizzati nella schermata della
## cronologia.
...
screen keyboard_help():
    ...
    hbox:
        label "Shift+A"
        text _("Apre il menu di accessibilità.")
...
style skip_triangle:
    ## Dobbiamo usare un carattere che contenga il glifo NERO TRIANGOLO PICCOLO
    ## IN PUNTA DESTRA.
    font "DejaVuSans.ttf"
...
## Schermo a bolle #############################################################
##
## La schermata bubble è usata per visualizzare il dialogo al giocatore quando
## si usano le bolle vocali. Lo schermo a bolle prende gli stessi parametri
## dello schermo say, deve creare un visualizzabile con l'id "what" e può creare
## visualizzabili con gli id "namebox", "who" e "window".
##
