...
define config.name = _("GabibboVN")
...
## Testo che viene inserito nella schermata del gioco. Posizionare il testo tra
## le virgolette triple e lasciare una riga vuota tra i paragrafi.
...
## variabili a False, si nasconde il mixer appropriato.
...
define config.save_directory = "GabibboVN-1719745506"
