...
## L'istruzione init offset fa sì che le istruzioni di inizializzazione in
## questo file vengano eseguite prima delle istruzioni di init in qualsiasi
## altro file.
init offset = -2
...
## Abilita i controlli per le proprietà non valide o instabili nelle schermate o
...
## La posizione del testo del menu principale.
...
##
## L'interfaccia grafica predefinita utilizza solo i cursori e le barre di
## scorrimento verticali. Tutte le altre barre sono utilizzate solo nelle
## schermate scritte dal creatore.
...
## Il numero massimo di voci in modalità NVL che Ren'Py visualizzerà. Se devono
## essere visualizzate più voci di questa, la voce più vecchia verrà rimossa.
...
init python:
    ...
    def small():
        ...
        ## Cambia la dimensione e la spaziatura di vari elementi.
        gui.slider_size = 54
